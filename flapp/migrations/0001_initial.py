    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('designation', models.CharField(choices=[('A', 'Author'), ('F', 'Founder'), ('CF', 'Co-Founder'), ('GA', 'Guest Author'), ('EC', 'Editor-in-Chief'), ('STE', 'Section Editor: Science & Technology Editor'), ('EFE', 'Section Editor: Economics & Finance Editor'), ('WAE', 'Section Editor: World Affairs Editor'), ('EE', 'Section Editor: Editorial Editor')], default='A', max_length=2)),
                ('linkedin_url', models.URLField(blank=True)),
                ('email', models.EmailField(blank=True, max_length=254)),
                ('bio', models.CharField(max_length=600)),
                ('slug', models.SlugField(blank=True, max_length=30, unique=True)),
